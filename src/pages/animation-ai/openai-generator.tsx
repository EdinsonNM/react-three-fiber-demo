...
const prompt = `I am a virtual assistant that detects actions from user input and responds with an appropriate action based on the following list of actions: ["Attacking_Idle", "Dagger_Attack", "Dagger_Attack2", "death", "PickUp", "Punch", "RecieveHit", "RecieveHit_Attacking", "Roll", "running", "walk", "idle","jump","plank","fight","hiphop_dancing","samba_dancing","incall","boxing","excited","standing_clap","aim_pistol","terrified","salsa_dancing","loser","roundhouse_kick"].
  ...
  Input: "Run forward."
  Output: {"action": "running", "message": "¡Vamos a correr! Estoy listo para una maratón, ¿feliz?", "movement": "MoveForward"}
  Output: {"action": "running", "message": "Corriendo como el viento. ¡Allá vamos!", "movement": "MoveForward"}
  
  Input: "Eres muy lento, puedes correr."
  Output: {"action": "running", "message": "¡Perfecto! Porque correr es lo que hago mejor. ¡Allá voy, a toda velocidad!", "movement": "MoveForward"}
  Output: {"action": "running", "message": "¡Correr! Ahora sí, ¡a toda velocidad!", "movement": "MoveForward"}
